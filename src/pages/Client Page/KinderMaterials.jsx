                            ...
                            >
                              ...
                              <td className="px-4 py-2 text-center align-top">
                                <button
                                  ...
                                  className="p-2 rounded-full bg-white hover:bg-pink-100 text-pink-700 shadow"
                                >
                                  <FaEye />
                                </button>
                              </td>
                ...
                >
                  {filteredMaterials.map((material) =>
                    view === "card" ? (
                      <div
                        key={material.id}
                        className="bg-gradient-to-br from-pink-100 to-pink-300 rounded-lg shadow-md p-6 transition-transform duration-200 hover:-translate-y-2 hover:shadow-xl"
                      >
                      ...
                      <div
                        key={material.id}
                        className="flex flex-col md:flex-row items-start bg-gradient-to-br from-pink-100 to-pink-300 rounded-lg shadow-md p-4 gap-4 hover:shadow-xl"
                      >
